...
GROUPS = {
    ...
    'CSU_C09_ORCRXARXR_SUPPGRP': ('sequence',
                (['ORC', SEGMENTS['ORC'], (0, 1), 'SEG'],
                 ['CSU_C09_RXARXR_SUPPGRP', None, (1, -1), 'GRP'],)),
    ...
    'CSU_C09_RXARXR_SUPPGRP': ('sequence',
    ...
    'CSU_C09_STUDY_SCHEDULE': ('sequence',
                (['CSS', SEGMENTS['CSS'], (0, 1), 'SEG'],
                 ...
                 ['CSU_C09_ORCRXARXR_SUPPGRP', None, (1, -1), 'GRP'],)),
    ...
    'MDM_T02_COMMON_ORDER': ('sequence',
                (['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
                 ...
                 ['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
                 ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],)),
    'MDM_T02_OBXNTE_SUPPGRP': ('sequence',
                (['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
                 ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],)),
    ...
    'ORD_O04_TIMING_TRAY': ('sequence',
                (['TQ1', SEGMENTS['TQ1'], (1, 1), 'SEG'],
                 ['TQ2', SEGMENTS['TQ2'], (0, -1), 'SEG'],)),
    'ORF_R04_OBXNTE_SUPPGRP': ('sequence',
                (['OBX', SEGMENTS['OBX'], (0, 1), 'SEG'],
                 ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],)),
    'ORF_R04_ORCOBRNTETQ1TQ2CTDOBXNTECTI_SUPPGRP': ('sequence',
                (['ORC', SEGMENTS['ORC'], (0, 1), 'SEG'],
                 ['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
                 ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
                 ['ORF_R04_TQ1TQ2_SUPPGRP', None, (0, -1), 'GRP'],
                 ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
                 ['ORF_R04_OBXNTE_SUPPGRP', None, (1, -1), 'GRP'],
                 ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],)),
    'ORF_R04_PIDNTEORCOBRNTETQ1TQ2CTDOBXNTECTI_SUPPGRP': ('sequence',
                (['ORF_R04_PIDNTE_SUPPGRP', None, (0, 1), 'GRP'],
                 ['ORF_R04_ORCOBRNTETQ1TQ2CTDOBXNTECTI_SUPPGRP', None, (1, -1), 'GRP'],)),
    'ORF_R04_PIDNTE_SUPPGRP': ('sequence',
                (['PID', SEGMENTS['PID'], (1, 1), 'SEG'],
                 ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],)),
    'ORF_R04_TQ1TQ2_SUPPGRP': ('sequence',
                (['TQ1', SEGMENTS['TQ1'], (1, 1), 'SEG'],
                 ['TQ2', SEGMENTS['TQ2'], (0, -1), 'SEG'],)),
    ...
    'ORR_O02_ORDER': ('sequence',
                (['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
                 ['ORR_O02_OBRRQDRQ1RXOODSODT_SUPPGRP', None, (1, 1), 'GRP'],
                 ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
                 ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],)),
    ...
    'OSR_Q06_ORDER': ('sequence',
                (['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
                 ...
                 ['OSR_Q06_OBRRQDRQ1RXOODSODT_SUPPGRP', None, (1, 1), 'GRP'],
                 ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
                 ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],)),
    ...
    'OUL_R22_ORDER': ('sequence',
                (['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
                 ...
                 ['OUL_R22_OBXTCDSIDNTE_SUPPGRP', None, (0, -1), 'GRP'],
                 ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],)),
    ...
    'OUL_R23_ORDER': ('sequence',
                (['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
                 ['ORC', SEGMENTS['ORC'], (0, 1), 'SEG'],
                 ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
                 ['OUL_R23_TQ1TQ2_SUPPGRP', None, (0, -1), 'GRP'],
                 ['OUL_R23_OBXTCDSIDNTE_SUPPGRP', None, (0, -1), 'GRP'],
                 ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],)),
    'OUL_R23_PIDPD1NTE_SUPPGRP': ('sequence',
                (['PID', SEGMENTS['PID'], (1, 1), 'SEG'],
                 ['PD1', SEGMENTS['PD1'], (0, 1), 'SEG'],
                 ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],)),
    'OUL_R23_PV1PV2_SUPPGRP': ('sequence',
                (['PV1', SEGMENTS['PV1'], (1, 1), 'SEG'],
                 ['PV2', SEGMENTS['PV2'], (0, 1), 'SEG'],)),
    ...
    'OUL_R23_TQ1TQ2_SUPPGRP': ('sequence',
                (['TQ1', SEGMENTS['TQ1'], (1, 1), 'SEG'],
                 ['TQ2', SEGMENTS['TQ2'], (0, -1), 'SEG'],)),
    ...
    'OUL_R24_ORDER': ('sequence',
                (['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
                 ['ORC', SEGMENTS['ORC'], (0, 1), 'SEG'],
                 ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
                 ['OUL_R24_TQ1TQ2_SUPPGRP', None, (0, -1), 'GRP'],
                 ['OUL_R24_SPMOBXSACINV_SUPPGRP', None, (0, -1), 'GRP'],
                 ['OUL_R24_OBXTCDSIDNTE_SUPPGRP', None, (0, -1), 'GRP'],
                 ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],)),
    'OUL_R24_PIDPD1NTE_SUPPGRP': ('sequence',
                (['PID', SEGMENTS['PID'], (1, 1), 'SEG'],
                 ['PD1', SEGMENTS['PD1'], (0, 1), 'SEG'],
                 ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],)),
    'OUL_R24_PV1PV2_SUPPGRP': ('sequence',
                (['PV1', SEGMENTS['PV1'], (1, 1), 'SEG'],
                 ['PV2', SEGMENTS['PV2'], (0, 1), 'SEG'],)),
    ...
    'OUL_R24_TQ1TQ2_SUPPGRP': ('sequence',
                (['TQ1', SEGMENTS['TQ1'], (1, 1), 'SEG'],
                 ['TQ2', SEGMENTS['TQ2'], (0, -1), 'SEG'],)),
    ...
    'PGL_PC6_ORDER_DETAIL': ('sequence',
                (['PGL_PC6_OBR_SUPPGRP', None, (1, 1), 'GRP'],
                 ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
                 ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
    ...
    'PPV_PCA_ORDER_DETAIL': ('sequence',
                (['PPV_PCA_ORDER_CHOICE', None, (1, 1), 'GRP'],
                 ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
                 ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
    ...
    'PRR_PC5_ORDER_DETAIL': ('sequence',
                (['PRR_PC5_OBRANYHL7SEGMENT_SUPPGRP', None, (1, 1), 'GRP'],
                 ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
                 ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
...
'SIU_S13_GENERAL_RESOURCE': ('sequence',
    ...
    'SUR_P09_FACPSHPDCPSHFACPDCNTEED_SUPPGRP': ('sequence',
                (['FAC', SEGMENTS['FAC'], (1, 1), 'SEG'],
                 ['SUR_P09_PSHPDC_SUPPGRP', None, (1, -1), 'GRP'],
                 ['PSH', SEGMENTS['PSH'], (1, 1), 'SEG'],
                 ['SUR_P09_FACPDCNTE_SUPPGRP', None, (1, -1), 'GRP'],
                 )),
    'SUR_P09_PSHPDC_SUPPGRP': ('sequence',
                (['PSH', SEGMENTS['PSH'], (1, 1), 'SEG'],
                 ['PDC', SEGMENTS['PDC'], (1, 1), 'SEG'],)),
