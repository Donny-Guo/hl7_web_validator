...
MESSAGES = {
    ...
    'DOC_T12': ('sequence',
                (('MSH', SEGMENTS['MSH'], (1, 1), 'SEG'),
                 ...
                 ('QAK', SEGMENTS['QAK'], (0, 1), 'SEG'),
                 ('QRD', SEGMENTS['QRD'], (1, 1), 'SEG'),
                 ('DOC_T12_EVNPIDPV1TXAOBX_SUPPGRP', GROUPS['DOC_T12_EVNPIDPV1TXAOBX_SUPPGRP'], (1, -1), 'GRP'),
                 ('DSC', SEGMENTS['DSC'], (0, 1), 'SEG'),)),
    'DSR_Q01': ('sequence',
                (('MSH', SEGMENTS['MSH'], (1, 1), 'SEG'),
                 ('SFT', SEGMENTS['SFT'], (0, -1), 'SEG'),
    ...
    'MDM_T02': ('sequence',
                (('MSH', SEGMENTS['MSH'], (1, 1), 'SEG'),
                 ...
                 ('TXA', SEGMENTS['TXA'], (1, 1), 'SEG'),
                 ('MDM_T02_OBXNTE_SUPPGRP', GROUPS['MDM_T02_OBXNTE_SUPPGRP'], (1, -1), 'GRP'),)),
    'MFK_M01': ('sequence',
                (('MSH', SEGMENTS['MSH'], (1, 1), 'SEG'),
                 ('SFT', SEGMENTS['SFT'], (0, -1), 'SEG'),
                 ('MSA', SEGMENTS['MSA'], (1, 1), 'SEG'),
    ...
    'NMD_N02': ('sequence',
                (('MSH', SEGMENTS['MSH'], (1, 1), 'SEG'),
                 ...
                 ('NMD_N02_CLOCK_AND_STATS_WITH_NOTES',
                  GROUPS['NMD_N02_CLOCK_AND_STATS_WITH_NOTES'], (1, -1), 'GRP'),)),
    'NMQ_N01': ('sequence',
                (('MSH', SEGMENTS['MSH'], (1, 1), 'SEG'),
                 ('SFT', SEGMENTS['SFT'], (0, -1), 'SEG'),
    ...
    'NMR_N01': ('sequence',
                (('MSH', SEGMENTS['MSH'], (1, 1), 'SEG'),
                 ...
                 ('NMR_N01_CLOCK_AND_STATS_WITH_NOTES_ALT',
                  GROUPS['NMR_N01_CLOCK_AND_STATS_WITH_NOTES_ALT'], (1, -1), 'GRP'),)),
    'OMB_O27': ('sequence',
                (('MSH', SEGMENTS['MSH'], (1, 1), 'SEG'),
                 ('SFT', SEGMENTS['SFT'], (0, -1), 'SEG'),
                 ('NTE', SEGMENTS['NTE'], (0, -1), 'SEG'),
    ...
    'ORF_R04': ('sequence',
                (('MSH', SEGMENTS['MSH'], (1, 1), 'SEG'),
                 ...
                 ('ORF_R04_PIDNTEORCOBRNTETQ1TQ2CTDOBXNTECTI_SUPPGRP',
                  GROUPS['ORF_R04_PIDNTEORCOBRNTETQ1TQ2CTDOBXNTECTI_SUPPGRP'], (1, -1), 'GRP'),
                 ('ERR', SEGMENTS['ERR'], (0, -1), 'SEG'),
                 ('QAK', SEGMENTS['QAK'], (0, 1), 'SEG'),
                 ('DSC', SEGMENTS['DSC'], (0, 1), 'SEG'),)),
    'ORG_O20': ('sequence',
    ...
    'OUL_R23': ('sequence',
                (('MSH', SEGMENTS['MSH'], (1, 1), 'SEG'),
                 ('SFT', SEGMENTS['SFT'], (0, -1), 'SEG'),
                 ('NTE', SEGMENTS['NTE'], (0, 1), 'SEG'),
                 ('OUL_R23_PIDPD1NTE_SUPPGRP', GROUPS['OUL_R23_PIDPD1NTE_SUPPGRP'], (0, 1), 'GRP'),
                 ('OUL_R23_PV1PV2_SUPPGRP', GROUPS['OUL_R23_PV1PV2_SUPPGRP'], (0, 1), 'GRP'),
                 ('OUL_R23_SPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI_SUPPGRP',
                  GROUPS['OUL_R23_SPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI_SUPPGRP'], (1, -1), 'GRP'),
                 ('DSC', SEGMENTS['DSC'], (0, 1), 'SEG'),)),
    'OUL_R24': ('sequence',
                (('MSH', SEGMENTS['MSH'], (1, 1), 'SEG'),
                 ('SFT', SEGMENTS['SFT'], (0, -1), 'SEG'),
                 ('NTE', SEGMENTS['NTE'], (0, 1), 'SEG'),
                 ('OUL_R24_PIDPD1NTE_SUPPGRP', GROUPS['OUL_R24_PIDPD1NTE_SUPPGRP'], (0, 1), 'GRP'),
                 ('OUL_R24_PV1PV2_SUPPGRP', GROUPS['OUL_R24_PV1PV2_SUPPGRP'], (0, 1), 'GRP'),
    ...
    'SUR_P09': ('sequence',
                (('MSH', SEGMENTS['MSH'], (1, 1), 'SEG'),
                 ('SUR_P09_FACPSHPDCPSHFACPDCNTEED_SUPPGRP',
                  GROUPS['SUR_P09_FACPSHPDCPSHFACPDCNTEED_SUPPGRP'], (1, -1), 'GRP'),)),
    'TBR_R08': ('sequence',
                (('MSH', SEGMENTS['MSH'], (1, 1), 'SEG'),
                 ('SFT', SEGMENTS['SFT'], (0, -1), 'SEG'),
                 ('MSA', SEGMENTS['MSA'], (1, 1), 'SEG'),
